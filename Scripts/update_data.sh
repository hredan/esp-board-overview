...
python ./pyScripts/create_esp8266_partition_schemes.py
...
cp /workspaces/esp-board-overview/esp_data/esp8266_partitions.json /workspaces/esp-board-overview/web-app/data/
cp /workspaces/esp-board-overview/esp_data/esp8266_partition_schemes.json /workspaces/esp-board-overview/web-app/data/
